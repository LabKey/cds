...
Ext.define('Connector.view.TermsOfUse', {
    ...
    tpl : new Ext.XTemplate(
        ...
        '</section>',
        '<section class="terms-block">',
            '<h4>Institutional and IRB Approvals</h4>',
        ...
        '</section>',
        '<section class="terms-block">',
            '<h4>Additional Terms and Conditions for Access to and Use of the MHRP Data Set.</h4>',
            '<p>',
        ...
        '</section>',
        '<section class="terms-block">',
            '<h4>Additional Terms and Conditions for Access to and Use of the CHAVI Data Set</h4>',
