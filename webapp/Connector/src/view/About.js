    ...
    tpl: new Ext.XTemplate(
    	'<tpl>',
	    	'<div class="signin-content">',
	            ...
	            '</p>',
	            '<p>',
	            	'The Data Connector currently includes data from the AIDS Vaccine Evaluation Group (est. 1988), ',
	            	'HIV Vaccine Trials Network (est. 2000), and the Collaboration for AIDS Vaccine Discovery ',
	            	'(est. 2006).',
	            '</p>',
	            '<div class="logoContainer">',
	            	'<img class="logo1" src="' + LABKEY.contextPath + '/Connector/images/logo_aveg.jpg">',
	            	'<img class="logo2" src="' + LABKEY.contextPath + '/Connector/images/logo_hvtn.jpg">',
	            	'<img class="logo3" src="' + LABKEY.contextPath + '/Connector/images/logo_cavd.jpg">',
	            '</div>',
	            '<p>',
