...
Ext.define('Connector.plugin.LoadingMask', {
    extend: 'Ext.AbstractPlugin', // TODO revert back to 'LABKEY.app.plugin.LoadingMask' in 16.1
    ...
    ITEMS_MASK_CLS: null,
    LOADING_DELAY: 500,
    PRODUCTION_GIF_PATH: Connector.resourceContext.imgPath + '/mask/', // TODO revert back to null in 16.1
