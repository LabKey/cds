                ...
                '<tpl if="publications && publications.length &gt; 0">',
                    ...
                    '<table class="learn-study-info">',
                        '<tpl for="publications">',
                            '<tpl if="xindex &lt; 11">',
                                '<tr>',
                                    '<td class="item-value"><a href="#learn/learn/Publication/{id}">{label:htmlEncode}:</a> {authors:htmlEncode}. {title:htmlEncode}. {journal:htmlEncode}. {date:htmlEncode};{volume}',
                                    '<tpl if="issue">',
                                        '({issue:htmlEncode})',
                                    '</tpl>',
                                    ':{location:htmlEncode}. ',
                        ...
                        '<table class="learn-study-info">',
                            '<tpl for="publications">',
                                '<tpl if="parent.showAll && (xindex &gt; 10)">',
                                    '<tr>',
                                        '<td class="item-value">{label:htmlEncode}: {authors:htmlEncode}. {title:htmlEncode}. {journal:htmlEncode}. {date:htmlEncode};{volume}',
                                        '<tpl if="issue">',
                                            '({issue:htmlEncode})',
                                        '</tpl>',
                                            ':{location:htmlEncode}. ',
