                                ...
                                '<tr>',
                                    '<tpl if="isLinkValid">',
                                        '<td class="item-value">',
                                            ...
                                            '&nbsp;{suffix}&nbsp;</span>',
                                            '<a style="display: inline-block" href="{filePath}" target="_blank"><img src="' + LABKEY.contextPath + '/Connector/images/download-icon.svg' + '" height="13" width="13" align="left"/></a>',
                                        '</td>',
