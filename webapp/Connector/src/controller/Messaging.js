 ...
 */
Ext.define('Connector.model.Message', {
...
Ext.define('Connector.controller.Messaging', {
    ...
    getType : function(type) {
        ...
        var TYPE = Connector.controller.Messaging.TYPES.INFO;

        if (!Ext.isEmpty(type)) {
            var caps = type.toUpperCase();

            if (Connector.controller.Messaging.TYPES[caps]) {
                TYPE = Connector.controller.Messaging.TYPES[caps];
            }
            else {
