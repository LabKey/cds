                        ...
                        '<tr>',
                            ...
                            '<td class="tile-detail" style="padding-left:10%;">',
                                '<div id="tours-wiki"><table>',
                                    '<tr><td>{[this.getTakeATourWiki()]}</td></tr>',
                                '</table></div>',
                            '</td>',
                            '<td class="tile-detail" style="padding-left:10%"><h3 class="tile-title">Try it out</h3>',
                                '<div><table>',
                                    '<tr><td class="tile-detail-static"><a href=\'#learn/learn/Study/\'">Learn about</a> studies, products, assays, antibodies, ad publications</td></td></tr>',
                                    '<tr><td class="tile-detail-static"><a href=\'#summary\'">Find subjects</a> with common characteristics</td></td></tr>',
                                    '<tr><td class="tile-detail-static"><a href=\'#chart\'">Plot</a> assay results across studies and years of research</td></td></tr>',
                                    '<tr><td class="tile-detail-static">Compare <a href=\'#mabgrid\'">Monoclonal antibodies</a> and their neutralization curves</td></td></tr>',
                                '</table></div>',
                            '</td>',
                            '<td class="tile-detail" style="padding-left:10%">',
