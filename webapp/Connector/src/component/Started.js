                        ...
                        '<table class="tile-group"><tr>',
                            '<td><div>',
                                '<table class="tile" id="home-video">',
                                    '<tr><td style="padding-top: 20px;"><div class="home_video backgroundimage"></div></td></tr>',
                                    '<tr><td><h3 class="tile-title" style="white-space: nowrap;">Watch the <a href="{videoURL}" target="_blank">Get Started</a> video</h3></td></td></tr>',
                                    '<tr><td>See the most powerful ways to explore the DataSpace.</td></tr>',
                                '</table>',
                            '</div></td>',
                            '<td><div>',
                                '<table class="tile" onclick="location.href=\'#learn/learn/Study/\'">',
                                    '<tr><td style="padding-top: 20px;"><div class="home_text backgroundimage"></div></td></tr>',
                        ...
                        '</tpl>',
                            '<td><div>',
                                '<table class="tile" onclick="location.href=\'#explorer/singleaxis/Study%20Product/Product%20Class\'">',
                                    '<tr><td style="padding-top: 20px;"><div class="home_bar backgroundimage"></div></td></tr>',
                            ...
                            '<td><div>',
                                '<table class="tile">',
                                    '<tr><td style="padding-top: 20px;"><div class="home_try_it_out backgroundimage"></div></td></tr>',
                                    '<tr><td><h3 class="tile-title">Try it out</h3></td></tr>',
                                    '<tr><td><a href=\'#learn/learn/Study/\' target="_blank">Learn about</a> studies, products, assays, antibodies, ad publications</td></td></tr>',
                                    // '<tr><td><a href=\'#summary\' target="_blank">Find subjects</a> with common characteristics</td></td></tr>',
                                    // '<tr><td><a href=\'#chart\' target="_blank">Plot</a> assay results across studies and years of research</td></td></tr>',
                                    // '<tr><td>Compare <a href=\'#mabgrid\' target="_blank">Monoclonal antibodies</a> and their neutralization curves</td></td></tr>',
                                '</table>',
                            '</div></td>',
                        '</tr></table>',
