            ...
            '>',
                ...
                '<a id="hidelink" href="#" onclick="return false;" class="started-dismiss">Hide &nbsp; <span style="font-size: 9px">&#x2715;</span></a>',
                    '<tpl if="videoURL">',
                        ...
                        '</tpl>',
                        '>',
                '<h3 class="tour-section-title bottom-spacer">Take A Tour</h3>',
                '<table class="tour-button-table">',
                '<tr>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="hopscotch.startTour(tour_get_oriented)">Get oriented</button>',
                    '</td>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="hopscotch.startTour(tour_active_filters)">Active filters</button>',
                    '</td>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="hopscotch.startTour(tour_learn_about)">Learn about</button>',
                    '</td>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="hopscotch.startTour(tour_find_subjects)">Find subjects</button>',
                    '</td>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="hopscotch.startTour(tour_plot_data)">Plot data</button>',
                    '</td>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="hopscotch.startTour(tour_view_data_grid)">View data grid</button>',
                    '</td>', 
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="hopscotch.startTour(tour_monoclonal_antibodies)">Monoclonal antibodies</button>',
                    '</td>',
                '</tr>',
                        ...
                        '<table class="tile-group"><tr>',
                            '<td><div>',
                                ...
                                '<tr><td><h3 class="tile-title">Answer questions</h3></td></tr>',
                                '<tr><td><div class="home_text backgroundimage"></div></td></tr>',
                                '<tr><td>Learn about <span class="started-count">{nstudy:htmlEncode}</span> CAVD studies, <span class="started-count">{nproduct:htmlEncode}</span> products, and <span class="started-count">{nassay:htmlEncode}</span> assays.</td></tr>',
                                '</table>',
                            '</div></td>',
                            '<td><div>',
                                '<table class="tile" onclick="location.href=\'#explorer/singleaxis/Study%20Product/Product%20Class\'">',
                                '<tr><td><h3 class="tile-title">Find a cohort</h3></td></tr>',
                        ...
                        '</tpl>',
                            '<td><div>',
                                '<table class="tile started-row-2" onclick="location.href=\'#chart\'">',
                                '<tr><td><h3 class="tile-title">Explore relationships</h3></td></tr>',
                                '<tr><td><div class="home_plot backgroundimage"></div></td></tr>',
                                '<tr><td>Plot assay results across <span class="started-count">{nsubjectstudy:htmlEncode}</span> studies and years of research.</td></tr>',
                                '</table>',
                            '</div></td>',
                            '<td><div>',
                                '<table class="tile started-row-2" id="home-video">',
                                '<tr><td><h3 class="tile-title">Get started!</h3></td></tr>',
