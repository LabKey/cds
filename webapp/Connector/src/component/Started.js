                ...
                '<td style="vertical-align: top;"><div>',
                    '<table class="tile">',
                        ...
                        '<tr><td style="padding-left: 25%"><div>',
                            ...
                            '<ul>',
                                '<li style="padding-bottom:10px"><a id="learn-about-link" href=\'#learn/learn/Study/\' target="_blank">Learn about</a> studies, products, assays, antibodies, ad publications</li>',
                                '<li style="padding-bottom:10px"><a id="find-subjects-link" href=\'#summary\' target="_blank">Find subjects</a> with common characteristics</li>',
                                '<li style="padding-bottom:10px"><a id="plot-link" href=\'#chart\' target="_blank">Plot</a> assay results across studies and years of research</li>',
                                '<li>Compare <a id="monoclonal-antibodies-link" href=\'#mabgrid\' target="_blank">Monoclonal antibodies</a> and their neutralization curves</li>',
                            '</ul>',
                        '</div></td></tr>',
                    '</table>',
                '</div></td>',
