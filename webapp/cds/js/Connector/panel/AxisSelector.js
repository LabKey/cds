 ...
 */
Ext4.define('Connector.panel.AxisSelector', {
    ...
    getSelectionDisplay : function() {
        ...
        this.selectDisplay = Ext4.create('Ext.Panel', displayConfig);

        this.scaleForm = Ext4.create('Ext.form.Panel', {
    ...
    getMeasurePicker : function() {
        ...
        Ext4.applyIf(this.measureConfig, {
            height : '52%',
            width  : '95%',
            allColumns : true,
            showHidden : false,
        ...
        Ext4.apply(this.measureConfig, {
            bubbleEvents: ['beforeMeasuresStoreLoad', 'measuresStoreLoaded', 'measureChanged']
        });

        this.measurePicker = Ext4.create('LABKEY.ext4.MeasuresDataView.SplitPanels', this.measureConfig);
