 ...
 */
Ext4.define('Connector.panel.Feedback', {
    ...
    constructor : function(config) {
        ...
        Ext4.apply(config, this.getPosition());
    ...
    initComponent : function() {
        ...
        this.resizeTask = new Ext4.util.DelayedTask(function(){
        ...
        this.on('afterrender', function() {
            ...
            // textarea
            var nav = new Ext4.util.KeyNav(this.getTextArea(), {
                'esc' : function(e) {
            ...
            // button
            var btnNav = new Ext4.util.KeyNav(this.submit.getEl(), {
                'tab' : function(e) {
                    this.submit.blur();
    ...
    getForm : function() {
        ...
        this.submit = Ext4.create('Connector.button.RoundedButton', {
            itemId: 'sbmtfback',
            cls   : 'dark',
            text  : 'Submit',
            hidden : true,
    ...
    onFeedbackRender : function(field) {
        var label = Ext4.DomQuery.select('label', field.getEl()['id']);
        if (label && label.length > 0) {
            Ext4.get(label[0]).applyStyles('float: left;');
            Ext4.DomHelper.insertAfter(label[0], {
                tag    : 'a',
    ...
    beforeSubmit : function() {
        ...
        this.runner = new Ext4.util.TaskRunner();
    ...
    onSubmit : function() {
        ...
        if (state && this.getState) {
            state.setValue(Ext4.encode(this.getState().data));
        }
    ...
    afterSubmit : function() {
        ...
        var wrapupTask = new Ext4.util.DelayedTask(function() {
    ...
    getTextArea : function() {
        return Ext4.DomQuery.select('textarea[name=description]', this.getForm().items.items[0].getEl().id)[0];
    },
