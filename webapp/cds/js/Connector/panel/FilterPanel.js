 ...
 */
Ext4.define('Connector.panel.FilterPanel', {
    ...
    initComponent : function() {
        ...
        var tbar = Ext4.create('Ext.toolbar.Toolbar', {
            dock: 'bottom',
            ui: 'footer',
            width: 230,
    ...
    createHierarchyFilter : function(filterset) {
        var me = this;
        return Ext4.create('Connector.panel.HierarchyFilter', {
            filterset : filterset,
...
Ext4.define('Connector.panel.SelectionPanel', {
...
Ext4.define('Connector.panel.HierarchyFilter', {
    ...
    initViewContainer : function() {
        ...
        this.viewContainer = Ext4.create('Ext.Container', {
            layout : {
                type : 'vbox',
                align: 'stretch'
            },
    ...
    getFilterView : function() {
        ...
        var viewTpl = new Ext4.XTemplate(
            '<tpl for=".">',
        ...
        viewTpl.renderLabel = function(val) {
            if (val == '#null')
                return 'Unknown';
            return Ext4.String.ellipsis(val, 16, false);
        };

        this.filterView = Ext4.create('Ext.view.View', {
            tpl : viewTpl,
    ...
    getHierarchyLabel : function() {
        ...
        return Ext4.create('Ext.Container', {
            html : html + extra,
            listeners : {
