...
Ext4.define('Connector.view.RawData', {
    ...
    initComponent : function() {
        ...
        this.exportButton = Ext4.create('Connector.button.RoundedButton', {
            text : 'Export',
            cls    : 'dark',
            margin : '5 0 0 5',
            handler : function() {
        ...
        this.axisPanel = Ext4.create('Connector.panel.AxisSelector', {
            flex      : 1,
            ui        : 'axispanel',
    ...
    refreshGrid : function(queryMetadata, measures, ptids, subjectColumn) {
        ...
        var onColumnModelCustomize = function(grid, columns) {
            ...
            Ext4.each(columns, function (col) {
                ...
                if (null != measureInfo) {
                    ...
                    col.header = "<span title='" + Ext4.htmlEncode(measureInfo.description) + "'>" + measureInfo.label+ "</span>";
                }
                else {
        ...
        this.store = Ext4.create('Connector.store.CDSStore', {
        ...
        this.bottomBar = Ext4.create('Ext.Panel', {
            ui : 'custom',
    ...
    getColumnList : function () {
        var cols = [];
        Ext4.each(this.queryMetadata.metaData.fields, function(col) {
    ...
    addLookupColumns : function(keyCol, cols) {
        ...
        Ext4.each(this.foreignColumns[keyCol.name], function (rec) {
    ...
    reapplyFilters : function (oldFilters, cols) {
        ...
        for (var i = 0; i < oldFilters.length; i++) {
            ...
            if (Ext4.Array.contains(cols, filtCol)) {
                ...
                if (slashPos != -1) {
                    ...
                    if (Ext4.Array.contains(cols, fkCol)) {
    ...
    onTriggerClick : function (headerCt, col, evt, el) {
        ...
        this.filterWin = Ext4.create('Connector.window.Filter', {triggerEl : el, col : col, rawDataView:this});
...
Ext4.define('Connector.window.Filter', {
    ...
    initComponent : function() {
        var box = Ext4.get(this.triggerEl).getBox();
    ...
    onAfterRender : function () {
        var keymap = new Ext4.util.KeyMap(this.el, [
            {
    ...
    getItems : function () {
        ...
        if (this.boundColumn.description) {
            items.push({xtype:'box', autoEl : {tag: 'div', cls:'x4-body', html:Ext4.htmlEncode(this.boundColumn.description)}});
        }
    ...
    getLookupColumnStore : function () {
        ...
        var store = Ext4.getStore(storeId);
        if (null != store) {
            return store;
        }
    ...
    applyFilters : function () {
        ...
        if (filterPanel.isValid()) {
            ...
            Ext4.window.Msg.alert("Please fix errors in filter.");
            return false;
        }
    },
...
Ext4.define('Connector.model.ColumnInfo', {
