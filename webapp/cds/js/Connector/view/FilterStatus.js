 ...
 */
Ext4.define('Connector.view.FilterStatus', {
    extend : 'Ext.Panel',
    ...
    getDetailStatus : function() {
        if (!this.detailstatus) {
            this.detailstatus = Ext4.create('Connector.view.DetailStatus', {
                store : this.store
            });
        }
    ...
    getFilterPanel : function() {
        ...
        this.filterpanel = Ext4.create('Connector.panel.FilterPanel', {
...
//                ,{ text: 'save view',  ui: 'rounded-inverted-accent', width: 85, itemId: 'saveview' }
    ...
    getSelectionPanel : function() {
        ...
        this.selectionpanel = Ext4.create('Connector.panel.SelectionPanel', {
...
Ext4.define('Connector.view.DetailStatus', {
    ...
    overItemCls: 'x4-btn-rounded-inverted-accent-icon-small',

    initComponent : function() {
        this.filterTask  = new Ext4.util.DelayedTask(this.filterChange, this);
           ...
           '<tpl for=".">',
                ...
                '<tpl if="highlight == undefined || !highlight">',
                    '<div class="status-row" style="width: 120px;">',
                        '<span class="x4-btn-inner">{count:this.commaFormat}&nbsp;{label}</span>',
