 ...
 */
Ext4.define('Connector.app.view.StudyProducts', {
    ...
    statics: {
        dateRenderer : Ext4.util.Format.dateRenderer("M jS, Y"),
        ...
        columnHeaderTpl : new Ext4.XTemplate(
    ...
    initComponent : function() {
        ...
        //
        this.emptyText = new Ext4.XTemplate(
