 ...
 */
Ext4.define('Connector.store.Summary', {
        ...
        if (this.count == 0)
        {
            ...
            for (var c=0; c < this.cache.length; c++)
            {
                if (this.cache[c].flight == this.flight)
                    subcache.push(Ext4.create('Connector.model.Summary', this.cache[c].config));
            }
            this.removeAll();
            this.add(subcache);
            this.cache = [];
...
//        }
    ...
    byStudy : function(qrArray, configArray) {
        ...
        var rec = {
            ...
            details   : d, //Ext4.String.ellipsis(this._listNames(cellset), 100, true),
            sort      : 0
        };
...
//            rec.details += '\n(' + splice + ')';
//
//        rec.details = Ext4.String.ellipsis(rec.details, 100, true);
        this.subAdd(rec, configArray[0].flight);
        this.done();
    },
    ...
    byAssay : function(qrArray, configArray) {
        ...
        var rec = {
            ...
            subject   : 'assays',
            hierarchy : cellset.axes[1].positions[0][0].level.hierarchy.name,
            details   : [], //Ext4.String.ellipsis(this._listNames(cellset), 100, true),
            sort      : 4
        };
...
//                nav: 'labsdetailpanel/' + names[d] // labs dont currently provide a detail page
    ...
    byVaccine : function(qrArray, configArray) {
        ...
        var rec = {
            ...
            details   : agg.details, //Ext4.String.ellipsis(agg.details, 100, true),
            sort      : 2
        };
