 ...
 * @private
 */
Ext.define('Connector.tree.Column', {
    extend: 'Ext.grid.column.Column',
    alias: 'widget.connectortreecolumn',
...
//                        ));
                        if (record.isLeaf()) {
                            buf.unshift(
                                '<span class="barlabel" unselectable="on">' + formattedValue +'</span>',
                                '<span class="count">' + record.raw.count +'</span>',
