...
DROP TABLE IF EXISTS cds.import_StudySubjectArm CASCADE; -- Renamed to import_StudyPartGroupArmSubject
...
CREATE TABLE cds.import_StudyPartGroupArmSubject (
  ...
  CONSTRAINT PK_import_StudyPartGroupArmSubject PRIMARY KEY (prot, subject_id, study_arm)
);
