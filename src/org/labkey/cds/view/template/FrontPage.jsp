        ...
        <div class="signin-modal">
            ...
            <div data-form="sign-in-help" class="sign-in-help hidden">
                ...
                <div class="links">
                    ...
                    <a href="#" data-click="confirm" class="confirm">Submit</a>
                </div>
            </div>
        </div>
    </div>
    <div class="forgot-password-modal-popup hidden">
        <div class="signin-modal">
            <div data-form="sign-in-help" class="sign-in-help">
                <div class="border"></div>
                <div class="title">
            ...
            <div class="modal">
                ...
                <form action="" method="" class="form">
                    <div class="credentials">
                        ...
                        <input placeholder="Re-enter Password" name="reenter-password" type="password" value="" required>
