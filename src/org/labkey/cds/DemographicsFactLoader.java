...
public class DemographicsFactLoader extends FactLoader
{
    ...
    {
        return new SQLFragment("INSERT INTO cds.facts (ParticipantId, Study, Container) SELECT ParticipantId, Study, Container FROM ").append(getTranslatedSelect());
    }

    private SQLFragment getTranslatedSelect()
    {
