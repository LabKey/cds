...
public class DemographicsFactLoader extends FactLoader
{
    ...
    public SQLFragment getPopulateSql()
    {
        ...
        //INSERT INTO cds.facts(ParticipantId, Study, Container) SELECT ptid AS ParticipantId, <studyColName> As Study, c.getId
    }
    ...
    private String getSelectSql()
    {
        ...
        String sql = "SELECT " + StringUtils.join(selectCols, ", ") + " FROM study.\"" + _sourceTableInfo.getName() + "\" WHERE " + participantMapper.getSourceColumn().getName() + " NOT IN (SELECT ParticipantId FROM cds.Facts)" ;
